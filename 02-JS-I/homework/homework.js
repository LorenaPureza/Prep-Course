...
function esPositivo(numero) {
  ...
  if (numero >0) {return 'Es positivo';}
   else if (numero <0) {return 'Es negativo';} else (numero == 0); return false;}
   

function agregarSimboloExclamacion(str){
   //agrega un simbolo de exclamacion al final de la string 'str' y devuelve una string 
   //Ejemplo:'hello world pasaria a ser 'hello world!'
  // tu código: 
    var simbolo = '!'
  return str + simbolo
}
...
function esVocal(letra){
 ...
 else ('Es vocal'!== letra); return 'Dato incorrecto'; 
